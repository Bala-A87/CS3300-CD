...
move $s3, $s3
sle $s4, $s2, $s1
beqz $s4, Element_Compare_L14
sne $s1, $s2, $s1
beqz $s1, Element_Compare_L14
li $s1, 1
move $s3, $s1
Element_Compare_L14:
nop
beqz $s3, Element_Compare_L12
li $s1, 0
move $s1, $s1
