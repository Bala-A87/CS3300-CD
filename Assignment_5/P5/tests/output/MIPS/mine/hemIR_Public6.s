...
move $s1, $v0
move $s1, $s1
la $s2, Class1_BMethod
sw $s2, 4($s0)
la $s2, Class1_CMethod
sw $s2, 8($s0)
la $s2, Class1_AMethod
sw $s2, 0($s0)
sw $s0, 0($s1)
move $v1, $s1
li $s0, 20
...
move $s2, $v0
move $s2, $s2
la $s3, Class1_BMethod
sw $s3, 4($s1)
la $s3, Class1_CMethod
sw $s3, 8($s1)
la $s3, Class3_AMethod
sw $s3, 0($s1)
la $s3, Class2_BMethod
sw $s3, 12($s1)
la $s3, Class3_DMethod
sw $s3, 16($s1)
la $s3, Class3_DMethod
sw $s3, 24($s1)
la $s3, Class3_FMethod
sw $s3, 28($s1)
la $s3, Class3_AMethod
sw $s3, 20($s1)
sw $s1, 0($s2)
